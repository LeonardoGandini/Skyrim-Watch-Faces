    ...
    private class Engine extends CanvasWatchFaceService.Engine {
      ...
      //  Paint mTickPaint;
        ...
        public void onCreate(SurfaceHolder holder) {
            ...
            setWatchFaceStyle(new WatchFaceStyle.Builder(AnalogFight.this)
                    .setCardPeekMode(WatchFaceStyle.PEEK_MODE_SHORT)
                    .setBackgroundVisibility(WatchFaceStyle.BACKGROUND_VISIBILITY_INTERRUPTIVE)
                    .setShowSystemUiTime(false)
                    .build());

            Resources resources = AnalogFight.this.getResources();
            Drawable backgroundDrawable = resources.getDrawable(R.drawable.fight);
            mBackgroundBitmap = ((BitmapDrawable) backgroundDrawable).getBitmap();


            mHourPaint = new Paint();
            mHourPaint.setARGB(255, 255, 108, 10);
            mHourPaint.setStrokeWidth(3.f);
            mHourPaint.setAntiAlias(true);
            mHourPaint.setStrokeCap(Paint.Cap.ROUND);

            mMinutePaint = new Paint();
            mMinutePaint.setARGB(255, 255, 108, 10);
            mMinutePaint.setStrokeWidth(3.f);
            mMinutePaint.setAntiAlias(true);
            mMinutePaint.setStrokeCap(Paint.Cap.ROUND);

            mSecondPaint = new Paint();
            mSecondPaint.setARGB(255, 0, 237, 232);
            mSecondPaint.setStrokeWidth(2.f);
            mSecondPaint.setAntiAlias(true);
            mSecondPaint.setStrokeCap(Paint.Cap.ROUND);

           /* mTickPaint = new Paint();
            mTickPaint.setARGB(155, 0, 0, 0);
       ...
       /* @Override
        ...
        public void onInterruptionFilterChanged(int interruptionFilter) {
            ...
            boolean inMuteMode = (interruptionFilter == AnalogFight.INTERRUPTION_FILTER_NONE);
            if (mMute != inMuteMode) {
                mMute = inMuteMode;
        ...
        private void registerReceiver() {
            ...
            AnalogFight.this.registerReceiver(mTimeZoneReceiver, filter);
        }
        ...
        private void unregisterReceiver() {
            ...
            AnalogFight.this.unregisterReceiver(mTimeZoneReceiver);
        }
